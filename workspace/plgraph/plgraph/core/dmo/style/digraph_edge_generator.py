...
class DigraphEdgeGenerator(object):
    """
    Purpose:
    Edge Generation for a plgraph.Digraph object

    Notes:
    -   'digraph-edge-generator' is not the same as 'plgraph-edge-generator'
    -   this module generates a library-specific Digraph edge element
    -   the plgraph-edge-generator creates a string value that conforms to the Graphviz format
    ...
    def __init__(self,
        ...
        from plgraph.core.dmo import EdgeStyleMatcher
